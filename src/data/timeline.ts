...
export const timelineData: TimelineItem[] = [
	{
		...
		title: "信息安全学士学位",
		description:
			"系统学习计算机科学基础理论，包括数据结构、算法、操作系统、数据库等核心课程。",
		type: "education",
	...
	// },
	{
		...
		description:
			"负责线下信息搜集访问校园内网，实施近源攻击，最终荣获“优秀攻击队”称号",
		type: "achievement",
	...
	},
	{
		...
		description:
			"负责Web方向题目的flag获取，最终荣获信息安全竞赛国家级三等奖",
		type: "achievement",
		startDate: "2025-05-01",
		endDate: "2025-07-02",
		location: "长春",
		organization:
			"中国兵工学会、北京理工大学、中国兵工学会信息安全与对抗专业委员会",
		position: "Web方向",
	...
	},
	{
		...
		title: "开始编程学习",
		description:
			"第一次接触编程，从C语言和C++开始，逐步学习Java和其他技术。",
		type: "education",
		startDate: "2024-07-01",
		skills: ["C语言", "C++", "Java"],
		achievements: [
