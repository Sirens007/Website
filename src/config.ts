...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/avatar.avif", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Sirens007",
	bio: "永遠相信，美好的事情即將發生",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.sirens007.cn", //https://twikoo.sirens007.cn/.netlify/functions/twikoo
		lang: SITE_LANG,
	},
	giscus: {
